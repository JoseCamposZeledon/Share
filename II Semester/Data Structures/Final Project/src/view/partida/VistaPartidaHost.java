...
public class VistaPartidaHost extends JFrame implements IConstants{
	...
	public VistaPartidaHost() {
		...
		readyHostLabel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		flagLabel.setBounds(73, 50, 100, 100);
		...
		borderLabel0.setBounds(65, 40, 120, 120);
		...
		archerLabel.setBounds(73, 230, 100, 100);
		...
		borderLabel1.setBounds(65, 220, 120, 120);
		...
		knightLabel.setBounds(73, 370, 100, 100);
		...
		borderLabel2.setBounds(65, 360, 120, 120);
		...
		brawlerLabel.setBounds(73, 510, 100, 100);
		...
		borderLabel3.setBounds(65, 500, 120, 120);
